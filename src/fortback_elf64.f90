...
contains
    ...
    subroutine emit_section_headers(bytes)
        ...
        call put_u32(bytes, 89, 1_int32)
        call put_u32(bytes, 93, 1_int32)
        call put_u64(bytes, 97, 6_int64)
        call put_u64(bytes, 113, 64_int64)
        call put_u64(bytes, 121, 4_int64)
        call put_u64(bytes, 137, 4_int64)
        call put_u32(bytes, 153, 11_int32)
        call put_u32(bytes, 157, 3_int32)
        call put_u64(bytes, 177, 68_int64)
        call put_u64(bytes, 185, 16_int64)
        call put_u64(bytes, 201, 1_int64)
