program test_mir_v0_bridge_generic_variable_divide
    ...
    character(len=*), parameter :: elf_path = &
        '/tmp/fortback-mir-v0-generic-variable-divide.elf'
    character(len=*), parameter :: output_path = &
        '/tmp/fortback-mir-v0-generic-variable-divide.out'

    input = initialized_variable_divide_input(-4)
    ...
    call assert_word(artifact%bytes, 197, [51, 69, 181, 2], 'x/x div encoding changed')
    ...
    call assert_true(output == '1'//achar(10), 'initialized x/x value changed')
...
contains
    ...
    function initialized_variable_divide_input(initializer) result(value)
        ...
        value = '(mir-function (name main) (entry-block 0) (instruction-count 9) '// &
            ...
            '(opcode div) (source-rule frontend-ast-v2/execution-part) '// &
    ...
    end function initialized_variable_divide_input
...
end program test_mir_v0_bridge_generic_variable_divide
