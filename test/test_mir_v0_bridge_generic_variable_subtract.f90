program test_mir_v0_bridge_generic_variable_subtract
    ...
    character(len=*), parameter :: elf_path = &
        '/tmp/fortback-mir-v0-generic-variable-subtract.elf'
    character(len=*), parameter :: output_path = &
        '/tmp/fortback-mir-v0-generic-variable-subtract.out'

    input = initialized_variable_subtract_input(42)
    ...
    call assert_word(artifact%bytes, 197, [51, 5, 181, 64], 'x-x sub encoding changed')
    ...
    call assert_true(output == '0'//achar(10), 'initialized x-x value changed')
...
contains
    ...
    function initialized_variable_subtract_input(initializer) result(value)
        ...
        value = '(mir-function (name main) (entry-block 0) (instruction-count 9) '// &
            ...
            '(opcode sub) (source-rule frontend-ast-v2/execution-part) '// &
    ...
    end function initialized_variable_subtract_input
...
end program test_mir_v0_bridge_generic_variable_subtract
