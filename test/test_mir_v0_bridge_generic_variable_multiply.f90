program test_mir_v0_bridge_generic_variable_multiply
    ...
    character(len=*), parameter :: elf_path = &
        '/tmp/fortback-mir-v0-generic-variable-multiply.elf'
    character(len=*), parameter :: output_path = &
        '/tmp/fortback-mir-v0-generic-variable-multiply.out'

    input = initialized_variable_multiply_input(42)
    ...
    call assert_word(artifact%bytes, 197, [51, 5, 181, 2], 'x*x mul encoding changed')
...
contains
    ...
    function initialized_variable_multiply_input(initializer) result(value)
        ...
        value = '(mir-function (name main) (entry-block 0) (instruction-count 9) '// &
            ...
            '(opcode mul) (source-rule frontend-ast-v2/execution-part) '// &
    ...
    end function initialized_variable_multiply_input
...
end program test_mir_v0_bridge_generic_variable_multiply
